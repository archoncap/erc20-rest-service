...
public class Controller {
    ...
    String deploy(
        ...
        System.out.println("TEST"+contractSpecification.getTokenName()+"TokenName");
        System.out.println("Test"+contractSpecification.getTokenSymbol()+"TokenSymbol");
    ...
    TransactionResponse<ApprovalEventResponse> approve(
            HttpServletRequest request,
    ...
    TransactionResponse<TransferEventResponse> transferFrom(
            HttpServletRequest request,
            @PathVariable String contractAddress,
    ...
    TransactionResponse<TransferEventResponse> transfer(
            HttpServletRequest request,
            @PathVariable String contractAddress,
            @RequestBody TransferRequest transferRequest) throws Exception {
        System.out.println(transferRequest.getValue());
    ...
    TransactionResponse<ApprovalEventResponse> approveAndCall(
            HttpServletRequest request,
            @PathVariable String contractAddress,
